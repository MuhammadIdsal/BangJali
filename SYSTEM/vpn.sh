#!/bin/bash
# Mod By BANGJALI-STORE

# By SKT AIO
# ==================================================
# Link Hosting Kalian
HOKAGE="https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/SYSTEM/"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/SYSTEM/vpn.zip
unzip vpn.zip
rm -f vpn.zip
