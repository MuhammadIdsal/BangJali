#!/bin/bash
REPO="https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
