...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/WEBSOCKET/ws-dropbear
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/WEBSOCKET/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/WEBSOCKET/ws-stunnel
chmod +x /usr/local/bin/ws-stunnel

# Installing Service
cat > /etc/systemd/system/ws-stunnel.service << END
[Unit]
Description=Python Proxy Mod By BANGJALI-STORE
