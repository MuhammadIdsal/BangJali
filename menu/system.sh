...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/MuhammadIdsal/BangJali/refs/heads/main/SLOWDNS/installsl.sh"
...
echo -e " $COLOR1║${NC} ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}DELETE USER EXPIRED ${WH}${WH}[${COLOR1}12${WH}]${NC} ${COLOR1}• ${WH}SPEED TEST         ${WH}$COLOR1║ $NC"
echo -e " $COLOR1╚══════════════════════════════════════════════════════╝${NC}"
echo -e ""
