...
if check_ip_and_get_info "$IP_VPS"; then
    ...
    echo -e "➥ Hubungi admin ${CYAN}「 ✦ @BangJali ✦ 」${NC}"
    exit 1
fi
...
echo -e "$COLOR1│ ${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}SSH VPN  ${WH}                ${WH}[${COLOR1}07${WH}]${NC} ${COLOR1}• ${WH}RESTART   ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│ ${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}VMESS    ${WH}                ${WH}[${COLOR1}08${WH}]${NC} ${COLOR1}• ${WH}REBOOT    ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│ ${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}VLESS    ${WH}                ${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${WH}UPDATE    ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│ ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}TROJAN   ${WH}                ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}SETTING   ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│ ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}BACKUP   ${WH}                ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}ONLINE    ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│ ${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}RUNNING  ${WH}                ${WH}[${COLOR1}12${WH}]${NC} ${COLOR1}• ${WH}ADMIN     ${WH}$COLOR1 │ $NC"
echo -e "$COLOR1│                                                   $COLOR1│ $NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
